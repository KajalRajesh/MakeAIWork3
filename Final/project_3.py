...
if num_classes == 2:
    if device == torch.device('cuda'):
        test_dir_resnet = "Resnet_GUI_Class_2.pth"
        test_dir_team = "TeamModel_GUI_Class_2.pth"
    else:
        test_dir_resnet = "Resnet_CPU_Class_2.pth"
        test_dir_team = "TeamModel_CPU_Class_2.pth"
    test_dir_data = "./Dataset/Test_class_2"
    classes = ('0', '1')
else:
    if device == torch.device('cuda'):
        test_dir_resnet = "Resnet_GUI_Class_4.pth"
        test_dir_team = "TeamModel_GUI_Class_4.pth"
    else:
        test_dir_resnet = "Resnet_CPU_Class_4.pth"
        test_dir_team = "TeamModel_CPU_Class_4.pth"
